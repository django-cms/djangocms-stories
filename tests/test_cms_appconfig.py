...
class TestGetNamespaceFromRequest:
    """Tests for get_namespace_from_request function"""

    def test_get_namespace_from_valid_path(self, simple_wo_placeholder):
    ...
    def test_get_namespace_from_toolbar_request_path(self):
    ...
    def test_get_namespace_handles_resolver404(self):
    ...
    def test_get_namespace_handles_resolver404_with_toolbar(self):
    ...
    def test_get_namespace_without_toolbar_attribute(self):
    ...
    def test_get_namespace_with_toolbar_but_no_request_path(self):
...
class TestGetAppInstance:
    ...
    def test_get_app_instance_returns_none_on_404(self):
    ...
    def test_get_app_instance_without_current_page(self, simple_wo_placeholder):
    ...
    def test_get_app_instance_config_does_not_exist(self):
    ...
    def test_get_app_instance_multiple_configs_returned(self, simple_wo_placeholder):
    ...
    def test_get_app_instance_with_cms_page_and_apphook(self, simple_wo_placeholder):
    ...
    def test_get_app_instance_with_page_but_no_apphook(self):
    ...
    def test_get_app_instance_resolver404_during_namespace_retrieval(self):
